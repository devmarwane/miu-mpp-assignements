...
public class Section {
	...
	public static void main(String[] args) {
		...
		System.out.println(streamSection(nextStream(), 0, 5).toList());
		System.out.println(streamSection(nextStream(), 2, 3).toList());
		System.out.println(streamSection(nextStream(), 3, 7).toList());
	}
